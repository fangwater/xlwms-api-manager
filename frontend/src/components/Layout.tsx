import { Archive, Truck, Bell, Boxes, ChartNoAxesCombined, ChevronDown, ClipboardCheck, Database, ExternalLink, Gauge, ListTodo, Menu, PackageCheck, PanelLeftClose, RefreshCw, ScanBox, Settings, SlidersHorizontal, TriangleAlert, Warehouse as WarehouseIcon } from "lucide-react";
...
const groups = [
  ...
  { label: "管理", items: [
    ...
    { path: "/packing", label: "装箱规划", icon: ScanBox },
    { path: "/inventory-thresholds", label: "库存安全线", icon: SlidersHorizontal },
    { path: "/sync", label: "同步中心", icon: RefreshCw }
  ] }
];
const pageNames: Record<string, string> = { "/": "运营总览", "/inventory": "库存中心", "/outbound": "出库管理", "/platform-orders": "平台订单待处理", "/fulfillment-audits": "履约核查", "/fulfilled-orders": "出库物流跟踪", "/delivery-evaluation": "快递评价", "/costs": "费用中心", "/warehouses": "仓库管理", "/inventory-alerts": "库存警告", "/sku-specs": "SKU 规格", "/packing": "装箱规划", "/inventory-thresholds": "库存安全线", "/sync": "同步中心", "/settings": "系统设置" };
