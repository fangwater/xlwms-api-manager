import { Truck, Bell, Boxes, ChartNoAxesCombined, ChevronDown, Database, Menu, PanelLeftClose, RefreshCw, Settings, Warehouse as WarehouseIcon } from "lucide-react";
...
const pageNames: Record<string, string> = { "/": "运营总览", "/inventory": "库存中心", "/outbound": "出库管理", "/costs": "费用中心", "/warehouses": "仓库管理", "/sync": "同步中心", "/settings": "系统设置" };
